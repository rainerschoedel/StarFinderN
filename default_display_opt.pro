...
;		'square', 'linear', 'square root' (default), 'logarithm'
;	color_table: long integer, representing the color table number (default 0)
;
; MODIFICATION HISTORY:
;	Written by: Emiliano Diolaiti, August 1999.
;
;	Changed default to settings Emiliano recommends in the tutorial,
;			Rainer Köhler, May 01
;-
;	Introduced LARGE keyword in options structure to enable
;       better display of large images,
;			Rainer Schödel, July 14
;-
...
FUNCTION default_display_opt, image
	...
	return, { range: range, chop: chop, reverse: 0B, $
			  stretch: 'square root', color_table: 15L, large: 0 }
	;; color table 15 is "Stern special"
