...
;       Modified by:    Rainer Schoedel, November 2015
;                       Fixed bug with INTERP_TYPE='F' option: lack of
;                       definition of variables sx and sy
;-
	...
	if  no_data  then begin
	   ...
	   imag = extend_array(image, extsiz[0], extsiz[1], OFFSET = offset)
           if  interp eq 'F'  then begin
              sx = siz[0] & sy = siz[1]    ; line inserted by Rainer Schoedel to fix bug, 30 Nov 2015
